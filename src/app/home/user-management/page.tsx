    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage all users in the system with role-based access control</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            {["all", "admin", "zoo_incharge", "veterinary_doctor", "citizen"].map((role) => (
