        ...
        <TabsContent value="group-visits" className="space-y-4">
          <div className="flex justify-between">
            ...
            <Button
              onClick={() =>
                router.push(
                  `${BASE_URL}group-visit?tab=group-visit&mode=create`
                )
              }
            >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      router.push(
                        `${
                          BASE_URL +
                          visit.name.split(" ").join("-").toLowerCase()
                        }?tab=group-visit&mode=edit`
                      );
              ...
              <Card key={booking.id} className="flex flex-col">
                <CardHeader className="pb-2 h-full flex-1">
                  <div className="flex justify-between">
                    ...
                    <div
                      className={`px-4 grid place-content-center py-0 rounded-full text-xs font-medium ${
